function [spurious_instances,edges_x, edges_y, edges_z] = detectSpuriousInstances_stemTip( ...
...
% Preallocate result
spurious_instances = 0;

% Loop over all instances (skip index 1 = stem)
 i = size(overallEdges_tree_concluded,1);
